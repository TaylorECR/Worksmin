	                  ...
	                  <div class="single-input">
	                     ...
	                     <select id="category_id" name="category_id">
	                        ...
	                        @foreach(\App\Category::orderBy('category')->pluck('category', 'id') as $id => $category)
	                             <option {{$job->id ? ((int) $job->subcategory->category->id === $id ? 'selected' : '' ) : ((int) old('category_id') === $id ? 'selected' : '' ) }}
	                              value="{{ $id }}">
	                                 {{ $category }}
	                             </option>
	                         @endforeach
	                  ...
	                  <div class="single-input">
	                     ...
	                     <select id="department_id" name="department_id">
	                        ...
	                        @foreach(\App\Department::orderBy('department')->pluck('department', 'id') as $id => $department)
	                             <option {{$job->id ? ((int) $job->province->department->id === $id ? 'selected' : '') : ((int) old('department_id') === $id ? 'selected' : '') }} value="{{ $id }}">
	                                 {{ $department }}
	                             </option>
	                         @endforeach
	                     </select>
	                  ...
	                  <div class="single-input">
	                     ...
	                     <select id="job_type_id" name="job_type_id" class="form-control @error('job_type_id') is-invalid @enderror">
	                        ...
	                        @foreach(\App\JobType::pluck('job_type', 'id') as $id => $job_type)
	                             <option {{$job->id ? ((int) $job->jobType->id === $id ? 'selected' : '') : ((int) old('job_type_id') === $id ? 'selected' : '') }} value="{{ $id }}">
	                                 {{ $job_type }}
	                             </option>
	                         @endforeach
	                     </select>
